...
namespace bcompass
{
    ...
    public class BCompassViewModel : INotifyPropertyChanged
    {
        ...
        List<Message> messages = new List<Message> {
            ...
            new Message("Blockbuster has over ten thousand videos!",0.5,0,0,-1,""),
            ...
            new Message("Blockbuster Blockbuster Blockbuster Blockbuster Blockbuster Blockbuster Blockbuster Blockbuster Blockbuster",0.2,0,0,-1,""),
